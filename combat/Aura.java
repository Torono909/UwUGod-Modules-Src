...
import meow.candycat.uwu.module.modules.misc.AutoTool;
...
public class Aura extends Module
{
    ...
    public Aura() {
        ...
        this.kmode = this.register(Settings.b("32k Mode"));
    }
    ...
    public void onUpdate() {
        ...
        if (this.kmode.getValue()) {
            final EntityPlayer uwu = (EntityPlayer)Aura.mc.field_71441_e.field_73010_i.stream().filter(e -> !Friends.isFriend(e.func_70005_c_())).filter(e -> e.func_70032_d((Entity)Aura.mc.field_71439_g) <= this.hitRange.getValue()).findFirst().orElse(null);
            if (uwu != null) {
                this.attack((Entity)uwu);
                this.attack((Entity)uwu);
                this.attack((Entity)uwu);
                this.attack((Entity)uwu);
                this.attack((Entity)uwu);
