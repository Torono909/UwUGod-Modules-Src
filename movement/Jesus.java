...
import meow.candycat.uwu.event.events.AddCollisionBoxToListEvent;
...
public class Jesus extends Module
{
    ...
    public Jesus() {
        ...
        this.packetEventSendListener = new Listener<PacketEvent.Send>(event -> {
            if (event.getEra() == UwUGodEvent.Era.PRE && event.getPacket() instanceof CPacketPlayer && EntityUtil.isAboveWater((Entity)Jesus.mc.field_71439_g, true) && !EntityUtil.isInWater((Entity)Jesus.mc.field_71439_g) && !isAboveLand((Entity)Jesus.mc.field_71439_g)) {
