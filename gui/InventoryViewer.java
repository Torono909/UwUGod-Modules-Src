...
import meow.candycat.uwu.gui.rgui.component.container.Container;
import meow.candycat.uwu.gui.rgui.util.ContainerHelper;
...
public class InventoryViewer extends Module
{
    ...
    public InventoryViewer() {
        ...
        this.uwUGodGUI = MeowUwU.getInstance().getGuiManager();
    }
    
    private int invPos(final int i) {
        this.uwUGodGUI = MeowUwU.getInstance().getGuiManager();
        if (this.uwUGodGUI != null) {
            final List<Frame> frames = ContainerHelper.getAllChildren((Class<? extends Frame>)Frame.class, (Container)this.uwUGodGUI);
