...
import meow.candycat.uwu.util.ColourHolder;
...
@Info(name = "ArmourHUD", category = Category.RENDER)
public class ArmourHUD extends Module
{
    ...
    public void onRender() {
        ...
        int iteration = 0;
        final int y = resolution.func_78328_b() - 55 - ((ArmourHUD.mc.field_71439_g.func_70090_H() && ArmourHUD.mc.field_71441_e.func_180495_p(ArmourHUD.mc.field_71439_g.func_180425_c().func_177982_a(0, 1, 0)).func_177230_c() == Blocks.field_150355_j) ? 10 : 0);
