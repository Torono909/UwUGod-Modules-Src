...
import meow.candycat.uwu.util.GeometryMasks;
import meow.candycat.uwu.util.UwUGodTessellator;
import org.lwjgl.opengl.GL11;
import meow.candycat.uwu.util.TrajectoryCalculator;
import net.minecraft.entity.EntityLivingBase;
import meow.candycat.uwu.event.events.RenderEvent;
import meow.candycat.uwu.util.HueCycler;
            ...
            Trajectories.mc.field_71441_e.field_72996_f.stream().filter(entity -> entity instanceof EntityLivingBase).map(entity -> entity).forEach(entity -> {
                ...
                if (tt != TrajectoryCalculator.ThrowingType.NONE) {
                    ...
                    if (hit != null) {
                        ...
                        UwUGodTessellator.drawBox(hit, 872415231, GeometryMasks.FACEMAP.get(flightPath.getCollidingTarget().field_178784_b));
