...
public class ChunkFinder extends Module
{
    ...
    private void logWriterOpen() {
        ...
        try {
            ...
            e.printStackTrace();
            MeowUwU.log.error("some exception happened when trying to start the logging -> " + e.getMessage());
    ...
    private Path getPath() {
        ...
        if (ChunkFinder.mc.func_71356_B()) {
            try {
                ...
                e.printStackTrace();
                MeowUwU.log.error("some exception happened when getting canonicalFile -> " + e.getMessage());
        ...
        try {
            ...
            e2.printStackTrace();
            MeowUwU.log.error("some exception happened when trying to make the file -> " + e2.getMessage());
