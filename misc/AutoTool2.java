...
@Info(name = "AutoTool2", description = "Automatically switch to the best tools when mining or attacking", category = Category.MISC)
public class AutoTool2 extends Module
{
    ...
    public AutoTool2() {
        this.leftClickListener = new Listener<PlayerInteractEvent.LeftClickBlock>(event -> this.equipBestTool(AutoTool2.mc.field_71441_e.func_180495_p(event.getPos())), (Predicate<PlayerInteractEvent.LeftClickBlock>[])new Predicate[0]);
    ...
    private void equipBestTool(final IBlockState blockState) {
        ...
        double max = 0.0;
        for (int i = 0; i < 9; ++i) {
            final ItemStack stack = AutoTool2.mc.field_71439_g.field_71071_by.func_70301_a(i);
    ...
    private static void equip(final int slot) {
        AutoTool2.mc.field_71439_g.field_71071_by.field_70461_c = slot;
        AutoTool2.mc.field_71442_b.func_78750_j();
    }
}
